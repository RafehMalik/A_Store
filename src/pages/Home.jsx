      ...
      <section className="border-b border-border bg-surface">
        <div className="container grid items-center gap-10 py-14 lg:grid-cols-2 lg:py-20">
          ...
          <div className="relative grid grid-cols-2 gap-4">
            <img
              src="https://images.unsplash.com/photo-1524634126442-357e0eac3c14?w=800&q=80"
              alt="A warm-lit living room corner with an amber table lamp"
            ...
            <img
              ...
              alt="A boucle lounge chair beside a window"
            ...
            <img
              ...
              alt="Hand-glazed stoneware plates stacked on a table"
              className="h-40 w-full rounded-lg object-cover sm:h-52"
            />
          </div>
        </div>
